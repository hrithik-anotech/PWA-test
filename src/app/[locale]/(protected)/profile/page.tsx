...
// Replace every src="/assets/..." path with your actual asset paths.
...
export default function ProfilePage() {
  return (
    <div className="flex justify-center items-start min-h-screen bg-gray-200">
      {/* Phone shell — fixed 375 px wide */}
      <div className="w-[375px] min-h-screen bg-[#F4F4F8] font-sans relative pb-8">

        {/* ── STATUS BAR ── */}
        <div className="flex justify-between items-center px-5 pt-3 pb-1">
          <span className="text-sm font-semibold text-black">9:41</span>
          <div className="flex items-center gap-1.5">
            <Image src="/assets/icons/signal.svg" alt="signal" width={16} height={12} />
            <Image src="/assets/icons/wifi.svg" alt="wifi" width={16} height={12} />
            <Image src="/assets/icons/battery.svg" alt="battery" width={25} height={12} />
          </div>
        </div>
