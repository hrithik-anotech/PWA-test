      ...
      <div className="mx-auto flex h-full w-full max-w-sm flex-col">
        ...
        <section className="relative flex h-[58dvh] items-center justify-center overflow-hidden px-6">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex h-36 w-36 items-center justify-center rounded-full bg-white/70 shadow-[0_20px_60px_rgba(91,47,209,0.12)] backdrop-blur-xl">
              <div className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#5B2FD1] to-[#8B5CF6] text-4xl font-bold text-white shadow-[0_10px_30px_rgba(91,47,209,0.35)]">
                404
              </div>
            </div>
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col">
            {/* TEXT */}
            <div>
              <h1 className="text-center text-[2rem] font-bold leading-tight tracking-[-0.04em]">
                {t('title')}
              </h1>

              <p className="mt-5 text-center text-[1rem] font-medium leading-relaxed text-white/82">
                {t('message')}
              </p>
            </div>
