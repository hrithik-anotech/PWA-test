...
const ICONS = {
  scooterTitle:   "/icons/scooter.svg",       // scooter next to "Worker on the way"
  scooterTracker: "/icons/scooter-small.svg", // smaller scooter on the progress bar
  house:          "/icons/house.svg",          // home / destination marker
  trackLive:      "/icons/track-live.svg",    // location pin inside Track Live button
  phone:          "/icons/phone.svg",          // phone inside Call button
  star:           "/icons/star.svg",           // filled star for rating
} as const;

const IMAGES = {
  workerPhoto: "/images/worker-photo.jpg",    // circular profile photo
} as const;
...
export default function ServiceTrackingCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start sm:items-end justify-between gap-4 sm:min-w-[200px]">
